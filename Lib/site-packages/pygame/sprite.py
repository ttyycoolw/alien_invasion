...
Group.draw() method requires that each Sprite have a Surface.images attribute
...
class Sprite(object):
    ...
    override the Sprite.update() method and assign Sprite.images and Sprite.rect
...
class DirtySprite(Sprite):
    ...
    source_rect = None
        ...
        left corner (0, 0) of self.images.
...
class LayeredDirty(LayeredUpdates):
    ...
    has the following attributes:
        images, rect, dirty, visible, blendmode (see doc of DirtySprite).
...
def collide_mask(left, right):
    ...
    otherwise, a mask is created from the sprite images. Intended to be passed
